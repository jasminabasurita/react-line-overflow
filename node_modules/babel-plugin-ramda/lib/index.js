...
exports.default = function (_ref) {
  ...
  function importMethod(useES, methodName, file) {
    if (!selectedMethods[methodName]) {
      var path = (0, _modules2.default)(useES, methodName);
      selectedMethods[methodName] = (0, _helperModuleImports.addDefault)(file.path, path, { nameHint: methodName });
    }
